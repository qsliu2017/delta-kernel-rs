...
mod tests {
    ...
    #[tokio::test]
    async fn test_add_files_simple() -> Result<(), Box<dyn std::error::Error>> {
        use super::simple::{add_file_simple, AddFileActionMetadata, DeletionVectorDescriptor};
        use std::ffi::CString;
